...
const Card = () => {
    ...
    return (  
        <div className="PageContent">
         ...
         <div className="CardImage-spacing image-margin"><img className="" src={PrimaryCard} alt="Illustration showing a Card component." /></div>
         <div className="SubHeader">Level 1 Dropdown</div>
         <div className="CardImage-spacing image-margin"><img className="" src={CardLevel1} alt="Illustration showing a card with a button expanded." /></div>

         <div className="SubHeader">Level 2 Dropdown</div>
         <div className="CardImage-spacing image-margin"><img className="" src={CardLevel2} alt="Illustration showing a card with a button expanded."/></div>
